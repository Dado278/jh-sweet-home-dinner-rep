...
export class AlertErrorComponent implements OnDestroy {
  ...
  constructor(private alertService: JhiAlertService, private eventManager: JhiEventManager, translateService: TranslateService) {
    this.errorListener = eventManager.subscribe('jhSweetHomeDinnerApplicationApp.error', (response: JhiEventWithContent<AlertError>) => {
            ...
            if (errorHeader) {
              ...
              for (const fieldError of fieldErrors) {
                ...
                const fieldName = translateService.instant(
                  'jhSweetHomeDinnerApplicationApp.' + fieldError.objectName + '.' + convertedField
                );
