...
export class SharedDinnerComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    if (this.currentSearch) {
      this.sharedDinnerService
        ...
        .subscribe(
          (res: HttpResponse<ISharedDinner[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
          () => this.onError()
        );
      return;
    }
  ...
  registerChangeInSharedDinners(): void {
    this.eventSubscriber = this.eventManager.subscribe('sharedDinnerListModification', () => this.loadPage());
  }
