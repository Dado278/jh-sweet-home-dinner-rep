...
export class InnkeeperComponent implements OnInit, OnDestroy {
  ...
  loadAll(): void {
    if (this.currentSearch) {
      this.innkeeperService
        ...
        .subscribe((res: HttpResponse<IInnkeeper[]>) => this.paginateInnkeepers(res.body, res.headers));
      return;
    }
  ...
  ngOnInit(): void {
    this.loadAll();
    this.registerChangeInInnkeepers();
  }
  ...
  registerChangeInInnkeepers(): void {
    this.eventSubscriber = this.eventManager.subscribe('innkeeperListModification', () => this.reset());
  }
