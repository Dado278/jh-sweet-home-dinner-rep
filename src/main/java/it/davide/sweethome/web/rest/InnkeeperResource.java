...
public class InnkeeperResource {
    ...
    public InnkeeperResource(InnkeeperService innkeeperService) {
    ...
    public ResponseEntity<Innkeeper> createInnkeeper(@Valid @RequestBody Innkeeper innkeeper) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/innkeepers/" + result.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, result.getId().toString()))
            .body(result);
    }

    /**
     * {@code PUT  /innkeepers} : Updates an existing innkeeper.
     *
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PutMapping("/innkeepers")
    public ResponseEntity<Innkeeper> updateInnkeeper(@Valid @RequestBody Innkeeper innkeeper) throws URISyntaxException {
        log.debug("REST request to update Innkeeper : {}", innkeeper);
        if (innkeeper.getId() == null) {
