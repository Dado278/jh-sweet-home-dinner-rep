...
public class Customer implements Serializable {
    ...
    public Customer avatarImageBlob(byte[] avatarImageBlob) {
    ...
    public Customer avatarImageBlobContentType(String avatarImageBlobContentType) {
    ...
    public Customer avatarTextBlob(String avatarTextBlob) {
