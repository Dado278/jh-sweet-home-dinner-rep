        ...
        return customerRepository
            ...
            .map(
                existingCustomer -> {
                    ...
                    if (customer.getAvatarImageBlob() != null) {
                        existingCustomer.setAvatarImageBlob(customer.getAvatarImageBlob());
                    }
                    if (customer.getAvatarImageBlobContentType() != null) {
                        existingCustomer.setAvatarImageBlobContentType(customer.getAvatarImageBlobContentType());
                    }
                    if (customer.getAvatarTextBlob() != null) {
                        existingCustomer.setAvatarTextBlob(customer.getAvatarTextBlob());
                    }
