...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, it.davide.sweethome.domain.Customer.class.getName() + ".sharedDinners");
            ...
            createCache(cm, it.davide.sweethome.domain.SharedDinner.class.getName() + ".customers");
