...
class InnkeeperResourceIT {
    ...
    private static final String DEFAULT_NICKNAME = "ilhv_k20x4yc6y7g";
    private static final String UPDATED_NICKNAME = "-2u";

    private static final Long DEFAULT_FRESHMAN = 1L;
    private static final Long UPDATED_FRESHMAN = 2L;

    private static final String DEFAULT_EMAIL = "w3c@91.yr.ixtzse";
    private static final String UPDATED_EMAIL = "n@yhobx.e.ozv";

    private static final String DEFAULT_PHONE_NUMBER = "04648186162759";
    private static final String UPDATED_PHONE_NUMBER = "69094155054311";
    ...
    private static final String DEFAULT_HOME_PAGE = "k5n.ut4tHV1/";
    private static final String UPDATED_HOME_PAGE = "http://2.iyhohiTiyekK/";
