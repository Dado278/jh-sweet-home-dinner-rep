...
class CustomerResourceIT {
    ...
    private static final String DEFAULT_EMAIL = ".6@3mbh.tffrqn";
    private static final String UPDATED_EMAIL = "-e@9.iiukhq";

    private static final String DEFAULT_PHONE_NUMBER = "01499159755376";
    private static final String UPDATED_PHONE_NUMBER = "858451222";
    ...
    void createCustomer() throws Exception {
        ...
        assertThat(testCustomer.getAvatarImageBlob()).isEqualTo(DEFAULT_AVATAR_IMAGE_BLOB);
        assertThat(testCustomer.getAvatarImageBlobContentType()).isEqualTo(DEFAULT_AVATAR_IMAGE_BLOB_CONTENT_TYPE);
        assertThat(testCustomer.getAvatarTextBlob()).isEqualTo(DEFAULT_AVATAR_TEXT_BLOB);
    ...
    void putNewCustomer() throws Exception {
        ...
        assertThat(testCustomer.getAvatarImageBlob()).isEqualTo(UPDATED_AVATAR_IMAGE_BLOB);
        assertThat(testCustomer.getAvatarImageBlobContentType()).isEqualTo(UPDATED_AVATAR_IMAGE_BLOB_CONTENT_TYPE);
        assertThat(testCustomer.getAvatarTextBlob()).isEqualTo(UPDATED_AVATAR_TEXT_BLOB);
