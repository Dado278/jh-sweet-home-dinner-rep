...
class CustomerResourceIT {
    ...
    private static final String DEFAULT_NICKNAME = "-5vdw";
    private static final String UPDATED_NICKNAME = "r41ihyx";

    private static final Long DEFAULT_FRESHMAN = 1L;
    private static final Long UPDATED_FRESHMAN = 2L;

    private static final String DEFAULT_EMAIL = "i-e@9.iiukhq";
    private static final String UPDATED_EMAIL = "aeq9-@j..ooktr";

    private static final String DEFAULT_PHONE_NUMBER = "858451222";
    private static final String UPDATED_PHONE_NUMBER = "76791917492";
